...
HD_PWD='/home/khyang/harvard/cs1410_lab/lab0/lab0_server/CS1410_lab0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_top.tcl -notrace
