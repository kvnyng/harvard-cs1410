...
HD_PWD='/home/khyang/harvard/cs1410_lab/lab0/lab0_server/CS1410_lab0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_top.tcl
