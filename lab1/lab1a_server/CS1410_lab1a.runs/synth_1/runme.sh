...
HD_PWD='/home/khyang/harvard/cs1410_lab/lab1/lab1a_server/CS1410_lab1a.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blackbox_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blackbox_wrapper.tcl
