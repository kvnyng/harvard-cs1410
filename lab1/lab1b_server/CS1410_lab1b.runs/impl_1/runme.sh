...
HD_PWD='/home/khyang/harvard/cs1410_lab/lab1/lab1b_server/CS1410_lab1b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_analyzer_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source logic_analyzer_wrapper.tcl -notrace
