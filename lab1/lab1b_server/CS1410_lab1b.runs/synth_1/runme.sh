...
HD_PWD='/home/khyang/harvard/cs1410_lab/lab1/lab1b_server/CS1410_lab1b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_analyzer_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logic_analyzer_wrapper.tcl
