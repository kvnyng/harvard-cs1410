...
class TrafficLightsApp:
    ...
    def setup_gui(self):
        ...
        self.clickrst_toggle.grid(row=1, column=1)
        ...
        self.traffic_light_ew.grid(row=2, column=1)
        self.create_traffic_light(self.traffic_light_ew, self.get_light_ew())
        ...
        self.ped_light_ew.grid(row=2, column=0)
        ...
        self.traffic_light_ns.grid(row=2, column=3)
        self.create_traffic_light(self.traffic_light_ns, self.get_light_ns()) 
        ...
        self.ped_light_ns.grid(row=2, column=2)
    ...
    def create_traffic_light(self, frame, light_color):
        ...
        red_light.create_oval(5, 5, 25, 25, fill=red_color)
        
        yellow_light = Canvas(frame, width=30, height=30, bg='black')
        yellow_light.grid(row=1, column=0)
        yellow_light.create_oval(5, 5, 25, 25, fill=yellow_color)
        
        green_light = Canvas(frame, width=30, height=30, bg='black')
        green_light.grid(row=2, column=0)
        green_light.create_oval(5, 5, 25, 25, fill=green_color)
    ...
    def create_ped_light(self, frame, light_color):
        ...
        amber_light.create_oval(5, 5, 25, 25, fill=amber_color)
    ...
    def update_lights(self):
        ...
        for widget in self.traffic_light_ns.winfo_children():
            widget.destroy()
        self.create_traffic_light(self.traffic_light_ns, traffic_light_ns_color)

        # Update East-West traffic light
        for widget in self.traffic_light_ew.winfo_children():
            widget.destroy()
        self.create_traffic_light(self.traffic_light_ew, traffic_light_ew_color)
