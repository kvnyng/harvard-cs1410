...
HD_PWD='/home/khyang/harvard/cs1410_lab/lab3/lab3_server/CS1410_lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tlc_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tlc_top.tcl -notrace
