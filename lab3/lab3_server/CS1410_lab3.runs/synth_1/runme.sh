...
HD_PWD='/home/khyang/harvard/cs1410_lab/lab3/lab3_server/CS1410_lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tlc_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tlc_top.tcl
