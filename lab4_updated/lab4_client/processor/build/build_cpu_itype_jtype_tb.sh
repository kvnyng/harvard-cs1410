...
# CPU I-Type and J-Type Instructions Testbench Build and Simulation Script
# This script compiles and runs the CPU I-type and J-type testbench

echo "=== CPU I-Type and J-Type Instructions Testbench Build Script ==="
...
echo "  - Compiling cpu_itype_jtype_tb.sv (testbench)"
...
echo "  - Creating simulation executable: cpu_itype_jtype_tb_sim"
echo "  - Enabling debug features"

xelab cpu_itype_jtype_tb -s cpu_itype_jtype_tb_sim -debug typical
...
echo "  - Executing comprehensive I-type and J-type instruction testbench"
echo "  - Testing I-type instructions (ADDI, ANDI, ORI, XORI, SLTI, LW, SW, BEQ, BNE)"
echo "  - Testing J-type instructions (J, JAL, JR)"
echo "  - Testing edge cases and boundary conditions"
echo "  - Verifying register file contents"

xsim cpu_itype_jtype_tb_sim -R
