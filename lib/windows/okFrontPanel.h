...
// clang-format off
	...
	#ifdef _MSC_VER
		#define okCPLUSPLUS_VERSION _MSVC_LANG
	#else
		#define okCPLUSPLUS_VERSION __cplusplus
	#endif
	#if okCPLUSPLUS_VERSION >= 201703L
		#define okNODISCARD [[nodiscard]]
	#else
		#define okNODISCARD
	#endif
	...
	#define DLL_ENTRY
	#if __cplusplus >= 201703L || __STDC_VERSION__ >= 202000L
		#define okNODISCARD [[nodiscard]]
	#else
		#define okNODISCARD __attribute__((warn_unused_result))
	#endif
...
#define OK_PRODUCT_XEM8305AU15P     (60)
...
enum okEProduct {
	...
	okPRODUCT_XEM8305AU15P = OK_PRODUCT_XEM8305AU15P,
...
okNODISCARD okDLLEXPORT const char* DLL_ENTRY okError_GetMessage(const okError* err);
...
#define OK_API_VERSION_MICRO 4

#define OK_API_VERSION_STRING "5.3.4"
...
// compiled with.
okNODISCARD okDLLEXPORT int DLL_ENTRY okFrontPanel_GetAPIVersionMajor();
okNODISCARD okDLLEXPORT int DLL_ENTRY okFrontPanel_GetAPIVersionMinor();
okNODISCARD okDLLEXPORT int DLL_ENTRY okFrontPanel_GetAPIVersionMicro();

okNODISCARD okDLLEXPORT const char* DLL_ENTRY okFrontPanel_GetAPIVersionString();

// Return true if the library version is at least equal to the given one.
okNODISCARD okDLLEXPORT Bool DLL_ENTRY
okFrontPanel_CheckAPIVersion(int major, int minor, int micro);
...
// okPLL22393
//
okNODISCARD okDLLEXPORT okPLL22393_HANDLE DLL_ENTRY okPLL22393_Construct();
...
okNODISCARD okDLLEXPORT double DLL_ENTRY okPLL22393_GetReference(okPLL22393_HANDLE pll);
...
okNODISCARD okDLLEXPORT int DLL_ENTRY okPLL22393_GetPLLP(okPLL22393_HANDLE pll, int n);
okNODISCARD okDLLEXPORT int DLL_ENTRY okPLL22393_GetPLLQ(okPLL22393_HANDLE pll, int n);
okNODISCARD okDLLEXPORT double DLL_ENTRY okPLL22393_GetPLLFrequency(okPLL22393_HANDLE pll, int n);
okNODISCARD okDLLEXPORT int DLL_ENTRY okPLL22393_GetOutputDivider(okPLL22393_HANDLE pll, int n);
okNODISCARD okDLLEXPORT ok_ClockSource_22393 DLL_ENTRY
okPLL22393_GetOutputSource(okPLL22393_HANDLE pll, int n);
okNODISCARD okDLLEXPORT double DLL_ENTRY
okPLL22393_GetOutputFrequency(okPLL22393_HANDLE pll, int n);
okNODISCARD okDLLEXPORT Bool DLL_ENTRY okPLL22393_IsOutputEnabled(okPLL22393_HANDLE pll, int n);
okNODISCARD okDLLEXPORT Bool DLL_ENTRY okPLL22393_IsPLLEnabled(okPLL22393_HANDLE pll, int n);


//
// okPLL22150
//
okNODISCARD okDLLEXPORT okPLL22150_HANDLE DLL_ENTRY okPLL22150_Construct();
...
okNODISCARD okDLLEXPORT double DLL_ENTRY okPLL22150_GetReference(okPLL22150_HANDLE pll);
okDLLEXPORT Bool DLL_ENTRY okPLL22150_SetVCOParameters(okPLL22150_HANDLE pll, int p, int q);
okNODISCARD okDLLEXPORT int DLL_ENTRY okPLL22150_GetVCOP(okPLL22150_HANDLE pll);
okNODISCARD okDLLEXPORT int DLL_ENTRY okPLL22150_GetVCOQ(okPLL22150_HANDLE pll);
okNODISCARD okDLLEXPORT double DLL_ENTRY okPLL22150_GetVCOFrequency(okPLL22150_HANDLE pll);
...
okNODISCARD okDLLEXPORT ok_DividerSource DLL_ENTRY okPLL22150_GetDiv1Source(okPLL22150_HANDLE pll);
okNODISCARD okDLLEXPORT ok_DividerSource DLL_ENTRY okPLL22150_GetDiv2Source(okPLL22150_HANDLE pll);
okNODISCARD okDLLEXPORT int DLL_ENTRY okPLL22150_GetDiv1Divider(okPLL22150_HANDLE pll);
okNODISCARD okDLLEXPORT int DLL_ENTRY okPLL22150_GetDiv2Divider(okPLL22150_HANDLE pll);
okDLLEXPORT void DLL_ENTRY
...
okNODISCARD okDLLEXPORT ok_ClockSource_22150 DLL_ENTRY
...
// okDeviceSensors
//
okNODISCARD okDLLEXPORT okDeviceSensors_HANDLE DLL_ENTRY okDeviceSensors_Construct();
okDLLEXPORT void DLL_ENTRY okDeviceSensors_Destruct(okDeviceSensors_HANDLE hnd);
okNODISCARD okDLLEXPORT int DLL_ENTRY okDeviceSensors_GetSensorCount(okDeviceSensors_HANDLE hnd);
okNODISCARD okDLLEXPORT okTDeviceSensor DLL_ENTRY
okDeviceSensors_GetSensor(okDeviceSensors_HANDLE hnd, int n);

//
// okDeviceSettingNames
//
okNODISCARD okDLLEXPORT okDeviceSettingNames_HANDLE DLL_ENTRY okDeviceSettingNames_Construct();
okDLLEXPORT void DLL_ENTRY okDeviceSettingNames_Destruct(okDeviceSettingNames_HANDLE hnd);
okNODISCARD okDLLEXPORT int DLL_ENTRY okDeviceSettingNames_GetCount(okDeviceSettingNames_HANDLE hnd
);
okNODISCARD okDLLEXPORT const char* DLL_ENTRY
okDeviceSettingNames_Get(okDeviceSettingNames_HANDLE hnd, int n);

//
// okDeviceSettings
//
okNODISCARD okDLLEXPORT okDeviceSettings_HANDLE DLL_ENTRY okDeviceSettings_Construct();
...
// okBuffer
//
okNODISCARD okDLLEXPORT okBuffer_HANDLE DLL_ENTRY okBuffer_Construct(unsigned size);
okNODISCARD okDLLEXPORT okBuffer_HANDLE DLL_ENTRY okBuffer_FromData(void* ptr, unsigned size);
okNODISCARD okDLLEXPORT okBuffer_HANDLE DLL_ENTRY okBuffer_Copy(okBuffer_HANDLE hnd);
okDLLEXPORT void DLL_ENTRY okBuffer_Destruct(okBuffer_HANDLE hnd);
okNODISCARD okDLLEXPORT okBool DLL_ENTRY okBuffer_IsEmpty(okBuffer_HANDLE hnd);
okNODISCARD okDLLEXPORT unsigned DLL_ENTRY okBuffer_GetSize(okBuffer_HANDLE hnd);
okNODISCARD okDLLEXPORT unsigned char* DLL_ENTRY okBuffer_GetData(okBuffer_HANDLE hnd);

//
// okScriptValue
//
okNODISCARD okDLLEXPORT okScriptValue_HANDLE DLL_ENTRY okScriptValue_Copy(okScriptValue_HANDLE h);
okNODISCARD okDLLEXPORT okScriptValue_HANDLE DLL_ENTRY okScriptValue_NewString(const char* s);
okNODISCARD okDLLEXPORT okScriptValue_HANDLE DLL_ENTRY okScriptValue_NewBool(okBool b);
okNODISCARD okDLLEXPORT okScriptValue_HANDLE DLL_ENTRY okScriptValue_NewInt(int n);
okNODISCARD okDLLEXPORT okScriptValue_HANDLE DLL_ENTRY okScriptValue_NewBuffer(okBuffer_HANDLE buf);
okNODISCARD okDLLEXPORT okBool DLL_ENTRY
okScriptValue_GetAsString(okScriptValue_HANDLE h, const char** ps);
okNODISCARD okDLLEXPORT okBool DLL_ENTRY
okScriptValue_GetAsBool(okScriptValue_HANDLE h, okBool* pb);
okNODISCARD okDLLEXPORT okBool DLL_ENTRY okScriptValue_GetAsInt(okScriptValue_HANDLE h, int* pn);
okNODISCARD okDLLEXPORT okBool DLL_ENTRY
...
// okScriptValues
//
okNODISCARD okDLLEXPORT okScriptValues_HANDLE DLL_ENTRY okScriptValues_Construct();
okNODISCARD okDLLEXPORT okScriptValues_HANDLE DLL_ENTRY okScriptValues_Copy(okScriptValues_HANDLE h
);
...
okNODISCARD okDLLEXPORT int DLL_ENTRY okScriptValues_GetCount(okScriptValues_HANDLE hnd);
okNODISCARD okDLLEXPORT okScriptValue_HANDLE DLL_ENTRY
okScriptValues_Get(okScriptValues_HANDLE hnd, int n);
...
// okFrontPanel
//
okNODISCARD okDLLEXPORT okFrontPanel_HANDLE DLL_ENTRY okFrontPanel_Construct();
#ifdef __ANDROID__
okNODISCARD okDLLEXPORT okFrontPanel_HANDLE DLL_ENTRY okFrontPanel_ConstructFromFD(int fd);
#endif // __ANDROID__
...
okNODISCARD okDLLEXPORT const char* DLL_ENTRY okFrontPanel_GetErrorMessage(ok_ErrorCode err);
okNODISCARD okDLLEXPORT const char* DLL_ENTRY
okFrontPanel_GetLastErrorMessage(okFrontPanel_HANDLE hnd);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
...
okNODISCARD okDLLEXPORT int DLL_ENTRY okFrontPanel_GetHostInterfaceWidth(okFrontPanel_HANDLE hnd);
okNODISCARD okDLLEXPORT Bool DLL_ENTRY okFrontPanel_IsHighSpeed(okFrontPanel_HANDLE hnd);
okNODISCARD okDLLEXPORT ok_BoardModel DLL_ENTRY okFrontPanel_GetBoardModel(okFrontPanel_HANDLE hnd);
okNODISCARD okDLLEXPORT ok_BoardModel DLL_ENTRY
...
okNODISCARD okDLLEXPORT int DLL_ENTRY okFrontPanel_GetDeviceCount(okFrontPanel_HANDLE hnd);
okNODISCARD okDLLEXPORT ok_BoardModel DLL_ENTRY
...
okNODISCARD okDLLEXPORT Bool DLL_ENTRY okFrontPanel_IsOpen(okFrontPanel_HANDLE hnd);
okNODISCARD okDLLEXPORT Bool DLL_ENTRY okFrontPanel_IsRemote(okFrontPanel_HANDLE hnd);
okDLLEXPORT void DLL_ENTRY
...
okNODISCARD okDLLEXPORT int DLL_ENTRY okFrontPanel_GetDeviceMajorVersion(okFrontPanel_HANDLE hnd);
okNODISCARD okDLLEXPORT int DLL_ENTRY okFrontPanel_GetDeviceMinorVersion(okFrontPanel_HANDLE hnd);
...
okNODISCARD okDLLEXPORT Bool DLL_ENTRY okFrontPanel_IsFrontPanelEnabled(okFrontPanel_HANDLE hnd);
okNODISCARD okDLLEXPORT Bool DLL_ENTRY okFrontPanel_IsFrontPanel3Supported(okFrontPanel_HANDLE hnd);
...
okNODISCARD okDLLEXPORT unsigned long DLL_ENTRY
...
okNODISCARD okDLLEXPORT UINT32 DLL_ENTRY
okFrontPanel_GetTriggerOutVector(okFrontPanel_HANDLE hnd, int epAddr);
okNODISCARD okDLLEXPORT long DLL_ENTRY okFrontPanel_GetLastTransferLength(okFrontPanel_HANDLE hnd);
...
// okScriptEngine
//
okNODISCARD okDLLEXPORT okScriptEngine_HANDLE DLL_ENTRY
okScriptEngine_ConstructLua(okFrontPanel_HANDLE fp);
okDLLEXPORT void DLL_ENTRY okScriptEngine_Destruct(okScriptEngine_HANDLE hnd);
okNODISCARD okDLLEXPORT Bool DLL_ENTRY okScriptEngine_LoadScript(
...
okNODISCARD okDLLEXPORT Bool DLL_ENTRY okScriptEngine_RunScriptFunction(
...
okNODISCARD okDLLEXPORT Bool DLL_ENTRY okScriptEngine_RunScriptFunctionAsync(
	okScriptEngine_HANDLE hnd,
...
// okFrontPanelManager
//
okNODISCARD okDLLEXPORT okCFrontPanelManager_HANDLE DLL_ENTRY
okFrontPanelManager_Construct(okFrontPanelManager_HANDLE self, const char* realm);
okNODISCARD okDLLEXPORT okCFrontPanelManager_HANDLE DLL_ENTRY
okFrontPanelManager_ConstructWithCallbacks(
...
okNODISCARD okDLLEXPORT okFrontPanel_HANDLE DLL_ENTRY
...
// FrontPanelDevices
//
okNODISCARD okDLLEXPORT okCFrontPanelDevices_HANDLE DLL_ENTRY
...
okNODISCARD okDLLEXPORT int DLL_ENTRY okFrontPanelDevices_GetCount(okCFrontPanelDevices_HANDLE hnd);
okDLLEXPORT void DLL_ENTRY
...
public:
	...
	okNODISCARD double GetReference();
	bool SetVCOParameters(int p, int q);
	okNODISCARD int GetVCOP();
	okNODISCARD int GetVCOQ();
	okNODISCARD double GetVCOFrequency();
	void SetDiv1(DividerSource divsrc, int n);
	void SetDiv2(DividerSource divsrc, int n);
	okNODISCARD DividerSource GetDiv1Source();
	okNODISCARD DividerSource GetDiv2Source();
	okNODISCARD int GetDiv1Divider();
	okNODISCARD int GetDiv2Divider();
	void SetOutputSource(int output, ClockSource clksrc);
	void SetOutputEnable(int output, bool enable);
	okNODISCARD ClockSource GetOutputSource(int output);
	okNODISCARD double GetOutputFrequency(int output);
	okNODISCARD bool IsOutputEnabled(int output);
};
...
public:
	okCPLL22393();
	~okCPLL22393();
	okNODISCARD bool SetCrystalLoad(double capload);
	...
	okNODISCARD int GetPLLP(int n);
	okNODISCARD int GetPLLQ(int n);
	okNODISCARD double GetPLLFrequency(int n);
	okNODISCARD int GetOutputDivider(int n);
	okNODISCARD ClockSource GetOutputSource(int n);
	okNODISCARD double GetOutputFrequency(int n);
	okNODISCARD bool IsOutputEnabled(int n);
	okNODISCARD bool IsPLLEnabled(int n);
};
...
public:
	...
	okNODISCARD static std::string GetErrorString(int errorCode);
	okNODISCARD static const char* GetErrorMessage(ErrorCode ec);
	okNODISCARD const char* GetLastErrorMessage() const;
	static ErrorCode
	...
	okNODISCARD int GetHostInterfaceWidth();
	okNODISCARD BoardModel GetBoardModel();
	okNODISCARD static BoardModel FindUSBDeviceModel(unsigned usbVID, unsigned usbPID);
	okNODISCARD static std::string GetBoardModelString(BoardModel m);
	okNODISCARD int GetDeviceCount();
	...
	okNODISCARD BoardModel GetDeviceListModel(int num);
	okNODISCARD std::string GetDeviceListSerial(int num);
	void EnableAsynchronousTransfers(bool enable);
	ErrorCode OpenBySerial(std::string str = "");
	okNODISCARD bool IsOpen();
	okNODISCARD bool IsRemote();
	ErrorCode GetDeviceInfo(okTDeviceInfo* info);
	okNODISCARD int GetDeviceMajorVersion();
	okNODISCARD int GetDeviceMinorVersion();
	okNODISCARD std::string GetSerialNumber();
	ErrorCode GetDeviceSettings(okCDeviceSettings& settings);
	ErrorCode GetDeviceSensors(okCDeviceSensors& sensors);
	okNODISCARD std::string GetDeviceID();
	...
	okNODISCARD bool IsHighSpeed();
	okNODISCARD bool IsFrontPanelEnabled();
	okNODISCARD bool IsFrontPanel3Supported();
	...
	okNODISCARD unsigned long GetWireOutValue(int epAddr);
	ErrorCode ActivateTriggerIn(int epAddr, int bit);
	ErrorCode UpdateTriggerOuts();
	okNODISCARD bool IsTriggered(int epAddr, UINT32 mask);
	okNODISCARD UINT32 GetTriggerOutVector(int epAddr) const;
...
public:
	...
	okNODISCARD int GetCount() const { return okDeviceSettingNames_GetCount(h); }
	okNODISCARD const char* Get(int n) const { return okDeviceSettingNames_Get(h, n); }
...
public:
	...
	okNODISCARD int GetSensorCount() const { return okDeviceSensors_GetSensorCount(h); }

	okNODISCARD okTDeviceSensor GetSensor(int n) const { return okDeviceSensors_GetSensor(h, n); }
...
okNODISCARD inline const char*
GetAPIVersionString()
{
	return okFrontPanel_GetAPIVersionString();
}

okNODISCARD inline bool
...
public:
	...
	okNODISCARD bool IsEmpty() const;
	okNODISCARD size_t GetSize() const;
	okNODISCARD unsigned char* GetData() const;

	okNODISCARD unsigned char& GetAt(size_t n);
	okNODISCARD unsigned char operator[](size_t n) const;
	okNODISCARD unsigned char& operator[](size_t n);
...
public:
	...
	okNODISCARD bool GetAsInt(int* pn) const;
	okNODISCARD bool GetAsBool(bool* pb) const;
	okNODISCARD bool GetAsString(std::string* ps) const;
	okNODISCARD bool GetAsBuffer(Buffer* pbuf) const;

	okNODISCARD bool IsNumber() const { return DoIsOfType<int>(); }
	okNODISCARD int GetNumber() const { return DoGetOfType<int>(); }
	okNODISCARD bool IsBool() const { return DoIsOfType<bool>(); }
	okNODISCARD bool GetBool() const { return DoGetOfType<bool>(); }
	okNODISCARD bool IsString() const { return DoIsOfType<std::string>(); }
	okNODISCARD std::string GetString() const { return DoGetOfType<std::string>(); }
	okNODISCARD bool IsBuffer() const { return DoIsOfType<Buffer>(); }
	okNODISCARD Buffer GetBuffer() const { return DoGetOfType<Buffer>(); }

	~ScriptValue();

private:
	okNODISCARD bool DoGetAsType(int* val) const { return GetAsInt(val); }
	okNODISCARD bool DoGetAsType(bool* val) const { return GetAsBool(val); }
	okNODISCARD bool DoGetAsType(std::string* val) const { return GetAsString(val); }
	okNODISCARD bool DoGetAsType(Buffer* val) const { return GetAsBuffer(val); }

	template <typename T>
	okNODISCARD bool DoIsOfType() const
	{
		T val;
	...
	template <typename T>
	okNODISCARD T DoGetOfType() const
	{
		T val;
		if (!DoGetAsType(&val))
...
public:
	...
	okNODISCARD int GetCount() const;
	okNODISCARD ScriptValue Get(int n = 0) const;
...
public:
	...
	okNODISCARD bool IsValid() const;
...
public:
	...
	okNODISCARD OpalKellyLegacy::okCFrontPanel* Open(const char* serial);
...
public:
	...
	okNODISCARD int GetCount() const;
	okNODISCARD std::string GetSerial(int num) const;
	okNODISCARD FrontPanelPtr Open(const std::string& serial = std::string()) const;
...
inline const char*
okCFrontPanel::GetErrorMessage(ErrorCode ec)
{
	return okFrontPanel_GetErrorMessage(static_cast<ok_ErrorCode>(ec));
}
inline const char*
